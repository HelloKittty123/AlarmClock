...
public class CircleAlarmTimerView extends View {
    ...
    public void setTime(int hours, int minutes) {
        this.mCurrentTime = (int) (hours * 60 + minutes) * 5 / 2 + 1;
        this.mCurrentRadian = (float) (this.mCurrentTime * Math.PI / 1800);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.restore();
        super.onDraw(canvas);
        System.out.println("0: " + mCurrentRadian);
        System.out.println("1: " + mCurrentRadian1);
        System.out.println("pre: " + mCurrentRadian);
    }
